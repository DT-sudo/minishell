...
#    Updated: 2025/09/18 16:03:37 by dt               ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
buildin_commands/echo_command_implementation_copy.c  buildin_commands/export_command_implementation.c  buildin_commands/unset_command_implementation.c
#	!!!	echo_command_implementation.c  -> echo_command_implementation_copy.c 
SRC = $(SRC_OP) $(SRC_DATA)
