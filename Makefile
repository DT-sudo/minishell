...
#    Updated: 2025/10/07 20:09:28 by dt               ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_OP = cmnd_list_utils.c creat_cmnd_list.c do_env_array.c dollar_list.c main.c env_init.c tokenizer.c help_file.c tokenizer_utils.c tokenizer_utils_2.c utils.c validate_input.c validate_input_2.c exit.c what_command.c \
